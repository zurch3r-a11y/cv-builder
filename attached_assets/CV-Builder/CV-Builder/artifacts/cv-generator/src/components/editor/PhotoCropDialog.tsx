...
export function PhotoCropDialog({ src, open, onClose, onApply }: PhotoCropDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-[420px]" data-testid="photo-crop-dialog">
        <DialogHeader>
        ...
        <div className="flex flex-col items-center gap-4 py-2">
          ...
          <button
            ...
            data-testid="button-reset-photo"
          >
        ...
        <DialogFooter className="gap-2">
          ...
          <Button onClick={handleApply} data-testid="button-apply-crop">
            Aplicar
          </Button>
        </DialogFooter>
      </DialogContent>
