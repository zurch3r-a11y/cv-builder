  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {data?.photoUrl && (
              <Button
                ...
                data-testid="button-adjust-photo"
      ...
      <div className="space-y-2">
        <Label>Nombre</Label>
        <Input name="firstName" value={data?.firstName || ''} onChange={handleChange} data-testid="input-firstName" />
      </div>
      <div className="space-y-2">
        <Label>Apellido</Label>
        <Input name="lastName" value={data?.lastName || ''} onChange={handleChange} data-testid="input-lastName" />
      </div>
      <div className="col-span-2 space-y-2">
        <Label>Título profesional</Label>
        <Input name="jobTitle" value={data?.jobTitle || ''} onChange={handleChange} data-testid="input-jobTitle" />
      </div>
      <div className="space-y-2">
        <Label>Correo electrónico</Label>
        <Input name="email" type="email" value={data?.email || ''} onChange={handleChange} data-testid="input-email" />
      </div>
      <div className="space-y-2">
        <Label>Teléfono</Label>
        <Input name="phone" value={data?.phone || ''} onChange={handleChange} data-testid="input-phone" />
      </div>
      <div className="col-span-2 space-y-2">
        <Label>Dirección</Label>
        <Input name="address" value={data?.address || ''} onChange={handleChange} data-testid="input-address" />
      </div>
      <div className="space-y-2">
        <Label>Código postal</Label>
        <Input name="postalCode" value={data?.postalCode || ''} onChange={handleChange} data-testid="input-postalCode" />
      </div>
      <div className="space-y-2">
        <Label>Localidad</Label>
        <Input name="locality" value={data?.locality || ''} onChange={handleChange} data-testid="input-locality" />
      </div>
      <div className="space-y-2">
        <Label>Ciudad</Label>
        <Input name="city" value={data?.city || ''} onChange={handleChange} data-testid="input-city" />
      </div>
      <div className="space-y-2">
        <Label>País</Label>
        <Input name="country" value={data?.country || ''} onChange={handleChange} data-testid="input-country" />
      </div>
      <div className="space-y-2">
        <Label>Fecha de nacimiento</Label>
        <Input name="birthDate" type="date" value={data?.birthDate || ''} onChange={handleChange} data-testid="input-birthDate" />
      </div>
      <div className="space-y-2">
        <Label>Nacionalidad</Label>
        <Input name="nationality" value={data?.nationality || ''} onChange={handleChange} data-testid="input-nationality" />
      </div>
      <div className="space-y-2">
        <Label>Estado civil</Label>
        <Input name="maritalStatus" value={data?.maritalStatus || ''} onChange={handleChange} data-testid="input-maritalStatus" />
      </div>
      <div className="space-y-2">
        <Label>C.I / Identificación</Label>
        <Input name="idNumber" value={data?.idNumber || ''} onChange={handleChange} data-testid="input-idNumber" />
      </div>
      <div className="space-y-2">
        <Label>LinkedIn</Label>
        <Input name="linkedin" value={data?.linkedin || ''} onChange={handleChange} data-testid="input-linkedin" />
      </div>
      <div className="space-y-2">
        <Label>Sitio web</Label>
        <Input name="website" value={data?.website || ''} onChange={handleChange} data-testid="input-website" />
      </div>
      <div className="col-span-2 space-y-2">
