    ...
    <div className="h-screen w-full flex flex-col bg-white overflow-hidden">
      ...
      <header className="border-b h-14 shrink-0 flex items-center justify-between px-4 bg-white z-10 shadow-sm">
        <div className="flex items-center gap-4">
          <Link href="/">
            <Button variant="ghost" size="icon" className="rounded-full h-8 w-8" data-testid="button-back">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2 text-sm">
            ...
            <Select value={template} onValueChange={setTemplate}>
              <SelectTrigger className="h-8 w-[140px] border-none shadow-none bg-gray-100 hover:bg-gray-200" data-testid="select-template">
